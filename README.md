...
- [Remove Blank Values From A Hash](https://github.com/jbranchaud/til/blob/master/rails/remove-blank-values-from-a-hash.md) <sup>`rails` · 2026-08-06</sup>
- [List And Count All Posts In TIL Repo](https://github.com/jbranchaud/til/blob/master/git/list-and-count-all-posts-in-til-repo.md) <sup>`git` · 2026-08-05</sup>
...
I've written <!-- TIL-COUNT-START -->1,853<!-- TIL-COUNT-END --> TILs and counting, more at [jbranchaud/til](https://github.com/jbranchaud/til).
...
<a href="https://github.com/jbranchaud/til/tree/master/python"><picture><source media="(prefers-color-scheme: dark)" srcset="assets/tiles/python-59-dark.svg"><img alt="python: 59 TILs" src="assets/tiles/python-59-light.svg"></picture></a>
