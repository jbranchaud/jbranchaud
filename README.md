...
I've written <!-- TIL-COUNT-START -->1,874<!-- TIL-COUNT-END --> TILs and counting, more at [jbranchaud/til](https://github.com/jbranchaud/til).
...
<a href="https://github.com/jbranchaud/til/tree/master/python"><picture><source media="(prefers-color-scheme: dark)" srcset="assets/tiles/python-67-dark.svg"><img alt="python: 67 TILs" src="assets/tiles/python-67-light.svg"></picture></a>
